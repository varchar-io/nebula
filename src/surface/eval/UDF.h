...
// define traits for UDF: ROUNDTOUNIT
// ROUNDTOUNIT function applies to integer type only.
STATIC_TRAITS(ROUNDTOUNIT, false)
UDF_TRAITS(ROUNDTOUNIT, nebula::type::Kind::BIGINT, nebula::type::Kind::BIGINT)
