...
TEST(UDFTest, TestRoundUnit) {
  ...
  week_test.eval(ctx);
  // EXPECT_EQ(week_test.eval(ctx), 4297384800);
  ...
  month_test.eval(ctx);
  // EXPECT_EQ(month_test.eval(ctx), 4296866400);
  ...
  // EXPECT_EQ(quarter_test.eval(ctx), 4291768800);
  ...
  year_test.eval(ctx);
  // EXPECT_EQ(year_test.eval(ctx), 4291768800);
}
