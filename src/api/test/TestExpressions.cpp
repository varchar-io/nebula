...
TEST(ExpressionsTest, TestSerde) {
  ...
  // expression with UDAF hist
  {
    ...
    auto expectedJson = "{\"b\":[[2.2250738585072014e-308,30.0,2,20.0],[30.0,35.0,0,0.0],[35.0,40.0,0,0.0],[40.0,45.0,1,40.0],[45.0,50.0,0,0.0],[50.0,55.0,0,0.0],[55.0,60.0,0,0.0],[60.0,65.0,1,60.0],[65.0,70.0,0,0.0],[70.0,75.0,0,0.0],[75.0,80.0,0,0.0],[80.0,1.7976931348623157e308,2,180.0]]}";
