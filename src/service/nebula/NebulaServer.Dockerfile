...
CMD ["/etc/nebula/NebulaServer", "--HOST_ADDR", "10.1.51.48", "--COMMENTS_FILE", "/home/shawncao/hadoop/comments.txt", "--COMMENTS_MAX", "100000", "--SIGNATURES_FILE", "/home/shawncao/hadoop/signatures.txt"]