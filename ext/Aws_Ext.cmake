...
add_library(${AWS_LIBRARY} PRIVATE IMPORTED)
target_link_libraries(${AWS_LIBRARY} 
  PRIVATE ${AWS_S3_LIBRARY}
  PRIVATE ${AWS_CORE_LIBRARY}
  PRIVATE ${AWS_CRT_LIBRARY}
  PRIVATE ${AWS_EVENTSTREAM_LIBRARY}
  PRIVATE ${AWS_CS3_LIBRARY}
  PRIVATE ${AWS_AUTH_LIBRARY}
  PRIVATE ${AWS_CAL_LIBRARY}
  PRIVATE ${AWS_MQTT_LIBRARY}
  PRIVATE ${AWS_HTTP_LIBRARY}
  PRIVATE ${AWS_COMPRESSION_LIBRARY}
  PRIVATE ${AWS_CHECKSUMS_LIBRARY}
  PRIVATE ${AWS_IO_LIBRARY}
  PRIVATE ${AWS_COMMON_LIBRARY}
  PRIVATE ${AWS_S2N_LIBRARY}
